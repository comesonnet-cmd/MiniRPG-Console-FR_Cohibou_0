...
namespace MiniRPG_Console_FR_Cohibou_0.Game
{
    public static class GameManager
    {
        ...
        public static double GetMultiplicateur(TypeElement attaquant, TypeElement defenseur)        // Crée un tableau 2D qui contient les multiplicateurs de dégâts selon le type qui attaque et celui qui défend.
