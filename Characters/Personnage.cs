...
namespace MiniRPG_Console_FR_Cohibou_0.Characters
{
    public class Personnage
    {
        ...
        public bool EstAccule(Personnage cible)
        {
            ...
            {
                if (GameManager.GetMultiplicateur(a.Type, cible.Type) > 0)
        ...
        {                                                                       // et inversement this devient l'ennemi et cible le joueur quand l'ennemi attaqe
            ...
            if (attaque.Type == TypeElement.Givre && cible.EstImmunise)         // 1. Vérifier immunité Givre AVANT les dégâts
            {
            ...
            // Calcul des dégâts
            double multiplicateur = GameManager.GetMultiplicateur(attaque.Type, cible.Type);    // Récupère le multiplicateur de dégâts selon les types de l'attaque et de la cible
